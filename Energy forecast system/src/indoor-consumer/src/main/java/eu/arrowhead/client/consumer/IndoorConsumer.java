...
public class IndoorConsumer extends ArrowheadConsumer {
  ...
  private ServiceRequestForm compileSRF() {
     ...
     */
    ArrowheadService service = new ArrowheadService("Indoor", Collections.singletonList("json"), metadata);
