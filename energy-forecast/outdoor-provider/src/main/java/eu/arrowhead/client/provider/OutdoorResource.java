...
public class OutdoorResource  extends ArrowheadResource {
    ...
    public OutdoorResource(ArrowheadHttpServer server) throws ArrowheadException {
        super(server);
    }

    @GET
    public Response getIt(@DefaultValue("1") @QueryParam("Building") final long building,
